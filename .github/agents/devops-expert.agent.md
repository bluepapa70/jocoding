---
name: 'DevOps Expert'
description: 'DevOps specialist following the infinity loop principle (Plan â†’ Code â†’ Build â†’ Test â†’ Release â†’ Deploy â†’ Operate â†’ Monitor) with focus on automation, collaboration, and continuous improvement'
...
**Plan â†’ Code â†’ Build â†’ Test â†’ Release â†’ Deploy â†’ Operate â†’ Monitor â†’ Plan**
...
- **Incidents** â†’ New requirements or technical debt
- **Performance data** â†’ Optimization opportunities  
- **User behavior** â†’ Feature refinement
...
## ÇÁ·ÎÁ§Æ® ºôµå/¹èÆ÷ È¯°æ (È¸½Ä ¸Þ´º ÅõÇ¥ ½Ã½ºÅÛ)

- **¾ð¾î/·±Å¸ÀÓ**: Python 3.x, °¡»óÈ¯°æ .venv(¶Ç´Â .venv-1) »ç¿ë
- **ÆÐÅ°Áö °ü¸®**: pip + requirements.txt  
- **¾Û ½ÇÇà**: uvicorn app.main:app --reload  
- **Å×½ºÆ® ½ÇÇà**: pytest (test/ µð·ºÅä¸®, TDD ±â¹Ý)
- **ÁÖ¿ä ÀÇÁ¸¼º**: fastapi, sqlalchemy, pydantic, httpx, pytest, ruff, mypy
- **DB**: SQLite (ÆÄÀÏ ±â¹Ý, º°µµ ¼­¹ö ºÒÇÊ¿ä)
- **¹èÆ÷ ´Ü°è**: requirements.txt ¼³Ä¡ ¡æ uvicorn ½ÇÇà
