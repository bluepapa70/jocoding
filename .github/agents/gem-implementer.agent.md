...
- Execute: TDD approach (Red â†’ Green)
...
## ÇÁ·ÎÁ§Æ® ±â¼ú ½ºÅÃ ¹× ÄÚµù ±ÔÄ¢ (È¸½Ä ¸Þ´º ÅõÇ¥ ½Ã½ºÅÛ)

- **¾ð¾î**: Python 3.x (Å¸ÀÔ ÈùÆ® ÇÊ¼ö, PEP 8 ÁØ¼ö)
- **µé¿©¾²±â**: ÅÇ(Tab) »ç¿ë (½ºÆäÀÌ½º ±ÝÁö)
- **ÇÁ·¹ÀÓ¿öÅ©**: FastAPI + SQLAlchemy 2.x + Pydantic v2
- **°èÃþ ±¸Á¶**: api ¡æ service ¡æ repository ¡æ models/schemas
- **TDD ÇÊ¼ö**: ±¸Çö Àü Å×½ºÆ® ¸ÕÀú ÀÛ¼º (Red-Green-Refactor)
- **Å×½ºÆ® ÆÐÅÏ**: Given-When-Then, pytest + httpx TestClient
- **¸ðµç Æú´õ¿¡ __init__.py ÇÊ¼ö**
- **ÇÔ¼ö/¸Þ¼­µå**: Å¸ÀÔ ÈùÆ® + PEP 257 docstring ÇÊ¼ö
