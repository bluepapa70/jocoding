...
## «¡∑Œ¡ß∆Æ ∏Æ∫‰ √º≈©∏ÆΩ∫∆Æ (»∏Ωƒ ∏ﬁ¥∫ ≈ı«• Ω√Ω∫≈€)

- **Architecture**: Layered (api °Ê service °Ê repository °Ê models/schemas)
- **Language**: Python 3.x with type hints and PEP 257 docstrings
- **Build Tool**: pip + requirements.txt
- **Testing**: pytest + httpx TestClient (TDD, Given-When-Then)
- **Code Style**: PEP 8, ≈« µÈø©æ≤±‚
- **¡÷ø‰ »Æ¿Œ «◊∏Ò**:
  - ∞Ë√˛ ∞£ ¿«¡∏ πÊ«‚ ¡ÿºˆ (ø™πÊ«‚ import ±›¡ˆ)
  - ∏µÁ ∆˙¥ıø° __init__.py ¡∏¿Á ø©∫Œ
  - ªı ±‚¥… Ω√ ≈◊Ω∫∆Æ ƒ⁄µÂ º±«‡ ¿€º∫ ø©∫Œ
  - SQLAlchemy ººº« ∞¸∏Æ ∆–≈œ ¿œ∞¸º∫
